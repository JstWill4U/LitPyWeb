...
from src.LitPyWeb import _re_flatten
...
class TestRoute(unittest.TestCase):
    ...
    def test_callback_inspection(self):
        ...
        def d(f):
            def w():
                return f()
            return w
        route = LitPyWeb.Route(LitPyWeb.Bottle(), None, None, d(x))
        ...
        route = LitPyWeb.Route(LitPyWeb.Bottle(), None, None, d2('foo')(x))
        self.assertEqual(route.get_undecorated_callback(), x)
        self.assertEqual(set(route.get_callback_args()), set(['a', 'b']))
    ...
    def test_callback_inspection_multiple_args(self):
        ...
        route = LitPyWeb.Route(LitPyWeb.Bottle(), None, None, x)
    ...
    def test_callback_inspection_newsig(self):
        ...
        route = LitPyWeb.Route(LitPyWeb.Bottle(), None, None, env['foo'])
        self.assertEqual(set(route.get_callback_args()), set(['a', 'b']))
