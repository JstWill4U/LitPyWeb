...
class TestRouter(unittest.TestCase):
    ...
    def testBasic(self):
        ...
        self.assertRaises(LitPyWeb.HTTPError, self.match, '//no/m/at/ch/')
    ...
    def testValueErrorInFilter(self):
        ...
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/int/noint')

    def testIntFilter(self):
        self.assertMatches('/object/<id:int>', '/object/567', id=567)
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/object/abc')
    ...
    def testFloatFilter(self):
        ...
        self.assertMatches('/object/<id:float>', '/object/1.', id=1)
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/object/abc')
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/object/')
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/object/.')
    ...
    def testParentheses(self):
        ...
        self.assertRaises(LitPyWeb.HTTPError, self.match, '/func2(baz)')
    ...
    def testBuild(self):
        ...
        self.assertRaises(LitPyWeb.RouteBuildError, build, 'test')
    ...
    def testBuildAnon(self):
        ...
        self.assertRaises(LitPyWeb.RouteBuildError, build, 'anonroute')
    ...
    def test_lots_of_routes(self):
        n = LitPyWeb.Router._MAX_GROUPS_PER_PATTERN+10
        for i in range(n):        
